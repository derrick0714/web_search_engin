    ...
    <div class="textAds lastTextAds wrap">
        <div id="SponSearch3">
        </div>
    </div>
    ...
    <div class="googleFooter wrap">
        <div>Search results powered by Xu Deng & Wang Qi</div>
    </div>
    <div class="feedBackFooter"><a href="mailto:derrick0714@gmail.com">Search Feedback</a></div>

    <div class="searchPagination wrap" id="searchPagination">
    </div>
    
            </div>
                                </div><!-- close bColumn -->                          </div><!-- close abColumn -->
            <div class="cColumn">
              
      <!--cur: prev:-->
  <div class="columnGroup first">       
    <div class="textAds firstTextAds columnGroup firstColumn wrap">
  <div id="SponSearch2">
  </div>
</div>  </div>
              </div>
