...
int main(int argc)
{
 ...
 StreamBuffer streambuf(1000*1000*1000*0.5);

 //streambuf1 is for the index structure
 StreamBuffer streambuf1(4000000);

 //streambuf2 is for the chunk index
 StreamBuffer streambuf2(4000000);

 streambuf.setfilename("result/data");
 streambuf1.setfilename("result/word_index");
 streambuf2.setfilename("result/chunk_index");
